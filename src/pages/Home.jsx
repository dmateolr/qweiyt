    ...
    <>
      ...
      <div className="flex md:mt-14  max-w-4xl gap-2 mx-auto mb-8">
        <div className="w-full md:w-[70%]">
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              className="bg-blue-500 hover:bg-blue-700 text-white-100 font-bold py-2 px-4 rounded"
            >
              Load More
            </button>
          </div>
        ...
        <div className="hidden md:mt-7 md:block md:w-[30%] p-3">
          <div className="flex items-center text-white-100 justify-between w-full gap-2">
            <div>
              <img
            ...
            <div className="flex-grow">
              <Link
                ...
                className="text-sm font-semibold text-white-100"
              >
                {userProfile?.username} 
              </Link>
              <p className="text-white-100 text-base">{userProfile?.fullName}</p>
            </div>
            <div className="text-sm font-bold text-blue-500">Switch</div>
          </div>
          <div>
            <div className="flex text-sm text-white-100 items-center my-2 justify-between">
              <div className="text-white-100  font-semibold">
                Suggestions For You
              </div>
          ...
          <div>
            {suggestUsers?.slice(1, 10).map((item, index) => (
              <div
                className="flex items-center text-white-100 justify-between my-2"
                key={index}
              >
                <div className="flex gap-2 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white-100">{item.fullName}</p>
                  </div>
                </div>
                <Link
                  to={`/${item?.username}`}
                  className="text-xs font-bold text-blue-100"
                >
                  Follow
                </Link>
              </div>
