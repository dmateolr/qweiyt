      ...
      <div className="h-screen w-screen flex flex-wrap items-center justify-center p-3">
        <div className="flex items-center">
          ...
          <div className="flex flex-col flex-shrink-0 w-[350px]">
            <div className="flex flex-col items-center justify-center rounded w-full border-[1px] border-gray-100 bg-stone-200 p-6">
              ...
              <div className="w-full px-5">
                ...
                >
                    ...
                    <div className="w-full">
                      <div className="w-full mb-3">
                        <input
                          ...
                          name="username"
                          type="text"
                          className="text-xs p-3 border-[1px] rounded bg-white-100 w-full border-gray-100"
                    ...
                    <div className="">
                      <div className="relative">
                        <input
                          ...
                          className="text-xs p-3 border-[1px] rounded bg-gwhite-100 w-full border-gray-100"
                  ...
                  <div className="text-center text-white-100 w-full text-xs font-thin mb-4">
            ...
            <div className="flex flex-col items-center justify-center rounded w-full border-[1px] border-gray-300 mt-4 bg-white p-6  text-white-100" >
